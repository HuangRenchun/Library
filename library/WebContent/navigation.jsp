...
<nav>
	<ul>
    	<li style="width:230px;background-color:#1E90FF;text-align:center"><span id="bgclock" class="word_white"></span></li>
        <li style="width:538px;background-color:#1E90FF;text-align: right;padding-right:10px;" class="word_white">
        ...
        <%}%><a  href="manager?action=querypwd" class="word_white">修改密码</a> | <a href="#" onClick="quit()" class="word_white">退出系统</a>
        </li>
    </ul>
</nav>
