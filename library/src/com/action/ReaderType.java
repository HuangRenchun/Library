...
public class ReaderType extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6468497947827052427L;
	...
	throws ServletException, IOException {
		...
		request.getRequestDispatcher("readerType_Modify.jsp").forward(request,response);
	}
	...
	throws ServletException, IOException {
		...
		readerTypeForm.setNumber(Integer.parseInt(request.getParameter("number1")));
